...
func (ctrl *APIController) setupProtectedRoutes(router *mux.Router) {
	...
	router.HandleFunc("/hosts/missing-dbs", ctrl.GetMissingDatabases).Methods("GET")
	...
	router.HandleFunc("/hosts/{hostname}/missing-dbs", ctrl.GetMissingDatabasesByHostname).Methods("GET")
